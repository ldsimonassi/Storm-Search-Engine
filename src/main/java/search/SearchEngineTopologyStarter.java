...
public class SearchEngineTopologyStarter {
	public static StormTopology createTopology() {
		...
		builder.setBolt("read-item-data", new ReadItemDataBolt(), 2).shuffleGrouping("indexer-spout");
	...
	private static Config createConf(String queriesPullHost, String feedPullHost, String itemsApiHost, int maxPull) {
